...
public class S3ImageStorageServiceImpl implements ImageStorageService {
    ...
    /**
     * {@link #uploadImages(List)} ile aynı, yalnızca depolama anahtarının
     * ön ekini seçmeye izin verir -- Instagram medyası (Faz 2) "external"
     * önekiyle saklanır, bkz. {@link ImageStorageService#uploadImages(List, String)}.
     */
    @Override
