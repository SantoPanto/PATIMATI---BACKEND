...
/**
 * Barınak bilgi kartı kaydet/güncelle isteği -- {@code PetShopUpsertRequest}'in
 * birebir aynısı (hayvan türü kapsam dışı, bkz. plan). Uç tek ve
...
public record ShelterUpsertRequest(
        ...
        @NotBlank(message = "Barınak adı zorunludur")
        @Size(max = 200, message = "Barınak adı en fazla 200 karakter olabilir")
        String name,
