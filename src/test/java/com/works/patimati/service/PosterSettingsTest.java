...
class PosterSettingsTest {
    ...
    void shouldUpdatePosterSettingsWhenCalledByOwner() {
        ...
        AdResponse mockResponse = new AdResponse(
                100L, "Başlık", "Açıklama", Ad.AdType.LOST, null, null, null, null, null, null, null, null, null, null, null, null, false, null, null, java.util.List.of(), null, null, 1L, "Owner", true, null, null, null, null, true, true, true
        );
