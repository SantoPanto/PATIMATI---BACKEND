...
class PosterSettingsTest {
    ...
    void shouldUpdatePosterSettingsWhenCalledByOwner() {
        ...
        AdResponse mockResponse = new AdResponse(
                100L, "Başlık", "Açıklama", Ad.AdType.LOST, null, null, null, null, null, null, null, null, null, null, null, null, false, null, null, java.util.List.of(), null, null, null, null, 1L, "Owner", null, true, false, null, null, null, null, true, true, true, com.works.patimati.entity.enums.AdResolutionStatus.NONE, true
        );
